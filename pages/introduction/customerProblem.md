...
<div class="relative w-150 h-150 flex items-center justify-center" style="width: 600px; height: 600px;">
  <div class="logo-grid" style="position:absolute;width:100%;height:100%;top:0;left:0;">
    ...
    <div class="logo-card" style="position:absolute;top:42%;right:5%;">
      <div class="logo-placeholder" :class="$clicks > 1 ? 'logo-highlight' : ''">Logo 3</div>
    </div>
    <div class="logo-card" style="position:absolute;bottom:18%;right:12%;">
      <div class="logo-placeholder">Logo 4</div>
    </div>
    <div class="logo-card" style="position:absolute;bottom:8%;left:45%;">
      <div class="logo-placeholder" :class="$clicks > 1 ? 'logo-highlight' : ''">Logo 6</div>
    </div>
    ...
    <div class="logo-card" style="position:absolute;top:18%;left:12%;">
      <div class="logo-placeholder">Logo 9</div>
    </div>
    <div class="logo-card" style="position:absolute;top:30%;left:50%;transform:translateX(-50%);opacity:0;">
      <div class="logo-placeholder">Logo 10</div>
    </div>
  </div>
